    ...
    <div class="header">
        ...
        <div class="content">
            ...
            <form class="content" method="post" enctype="multipart/form-data">
                ...
                <input type="text" name="title" class="input1" value="<?php echo $row['title']; ?>" oninput="validateAndReplace(this)"><br>
                <label for="content" class="label2">Content</label><br>
                <textarea input type="text" name="content" class="input2" oninput="validateAndReplace(this)"><?php echo $row['content']; ?></textarea>
